...
public class Lab4_SebastianRamirezCamiloFerrera {
                        ...
                        if (jugadores.size() == 0){
                            ...
                            if (disponible == false) {
                                ...
                                if (camisavalida == true){
                                    ...
                                    System.out.println("Ya hay un jugador con su numero de camisa, no se pudo añadir.");
                                }
                            }
                        }
                    } catch (Exception e) {
                        System.out.println("No se encontro nada con String, no se añadio nada. Regresando al menú...");
                    }
    ...
    static boolean ValidarJuego(){
        boolean valido = false;
        if (equipos.size() >= 2){
            for (int i = 0; i < equipos.size(); i++) {
                if (equipos.get(i).getJugadores().size() == 7){
                    valido = true;
                } else {
                    valido = false;
                    break;
